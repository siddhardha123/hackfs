      ...
      <div className="flex flex-wrap mx-20">
        <div className="w-full px-2">
          <div className="text-white shadow-lg p-4 mb-4 profile-card">
            ...
            <p className="text-gray-300 text-xl">{longDesc}</p>
